...
- [1) 웹(Web)이란?](#1-웹web이란)
- [2) IP 주소와 DNS](#2-ip-주소와-dns)
- [3) URL과 URI](#3-url과-uri)
  - [3-1) URL의 구성 요소](#3-1-url의-구성-요소)
  - [3-2) URI와 URL의 차이점 요약](#3-2-uri와-url의-차이점-요약)
- [4) 호스트와 포트](#4-호스트와-포트)
- [5) 클라이언트-서버 구조](#5-클라이언트-서버-구조)
- [6) HTTP와 HTTPS](#6-http와-https)
- [7) 인증과 인가](#7-인증과-인가)
- [10) 웹 페이지의 동작 흐름](#10-웹-페이지의-동작-흐름)
- [11) 프론트엔드와 백엔드](#11-프론트엔드와-백엔드)
- [12) 웹 브라우저와 개발자 도구](#12-웹-브라우저와-개발자-도구)
- [13) 정적 웹 vs 동적 웹](#13-정적-웹-vs-동적-웹)
  - [13-1) 웹 서버 vs 웹 애플리케이션 서버](#13-1-웹-서버-vs-웹-애플리케이션-서버)
- [14) REST API](#14-rest-api)
- [15) HTML, CSS, JavaScript의 역할](#15-html-css-javascript의-역할)
