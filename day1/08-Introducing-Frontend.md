...
1. [프론트엔드(Frontend)란?](#1-프론트엔드frontend란)
2. [프론트엔드의 3대 핵심 기술](#2-프론트엔드의-3대-핵심-기술)
   - [2-1) HTML (HyperText Markup Language)](#2-1-html-hypertext-markup-language)
   - [2-2) CSS (Cascading Style Sheets)](#2-2-css-cascading-style-sheets)
   - [2-3) JavaScript](#2-3-javascript)
3. [프론트엔드 개발자의 주요 역할](#3-프론트엔드-개발자의-주요-역할)
4. [현대 프론트엔드 개발 생태계](#4-현대-프론트엔드-개발-생태계)
   - [4-1) 프레임워크와 라이브러리](#4-1-프레임워크와-라이브러리)
   - [4-2) 패키지 매니저 (Package Manager)](#4-2-패키지-매니저-package-manager)
   - [4-3) 빌드 도구 (Build Tools) & 번들러 (Bundler)](#4-3-빌드-도구-build-tools--번들러-bundler)
   - [4-4) 버전 관리 시스템 (Version Control System)](#4-4-버전-관리-시스템-version-control-system)
5. [프론트엔드 vs. 백엔드](#5-프론트엔드-vs-백엔드)
6. [프론트엔드 학습 로드맵 (초급)](#6-프론트엔드-학습-로드맵-초급)
