...
| **5. 커스텀 Hook & API 연동**              | • Custom Hook의 개념과 필요성<br>• useEffect Hook 심화 | • fetch/axios를 이용한 API 연동<br>• REST API 규약                               | • 데이터 로딩/캐싱을 위한 Custom Hook 제작                                | ✔ Custom Hook 1개 이상 구현<br>✔ API 연동 기능 구현              |
