...
| ------------------------------------- | ------------------------------------------------------ | ----------------------------------------------------------------------------- | --------------------------------------------------------------- | ------------------------------------------------------ |
| **1. 개발 환경 & GitHub 세팅**              | • 웹 기본 개념<br>• 프론트엔드 로드맵 · SPA 개념<br>• VS Code 플러그인, Node & Vite 설치 | • [GitHub 시작하기](day1/05-GitHub.md)<br>• Markdown 작성            | • 개인 레포·Team Org 생성, 기본 README 작성                               | ✔ GitHub repo/프로젝트 보드 개설<br>✔ Notion 스페이스·Velog 블로그 개설 |
